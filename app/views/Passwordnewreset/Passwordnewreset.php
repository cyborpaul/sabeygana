...
<!-- jQuery -->
<script src="<?=FOLDER_PATH?>/app/assets/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script src="<?=FOLDER_PATH?>/app/assets/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="<?=FOLDER_PATH?>/app/assets/dist/js/adminlte.min.js"></script>
</body>
</html>
